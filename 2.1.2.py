...
class DataSet:
    ...
    def average(dictionary):
        return DataSet.averagevalue(dictionary)

    @staticmethod
    def averagevalue(dictionary):
        new_dictionary = {}
    ...
    def get_statistic(self):
        count_of_vacancies, salary, salary_city, salary_of_vacancy_name = self.statistic_values()

        count_of_vacancies = self.counter_vacancies(count_of_vacancies, salary, salary_city, salary_of_vacancy_name)
        ...
        stats, stats2, stats3, stats5, vacancies_number_by_name = self.statistics(count_of_vacancies, salary,
                                                                                  salary_city, salary_of_vacancy_name,
                                                                                  vacancies_number,
                                                                                  vacancies_number_by_name)

        return stats, vacancies_number, stats2, vacancies_number_by_name, stats3, stats5

    def statistics(self, count_of_vacancies, salary, salary_city, salary_of_vacancy_name, vacancies_number,
                   vacancies_number_by_name):
        ...
        return stats, stats2, stats3, stats5, vacancies_number_by_name

    def counter_vacancies(self, count_of_vacancies, salary, salary_city, salary_of_vacancy_name):
